<?php $this->load->view('admin/layout/header', ['title' => isset($title) ? $title : 'Senarai Produk']); ?>
...
<div class="rounded-lg border border-gray-200 bg-white shadow-sm">
  <div class="px-5 py-3 border-b border-gray-200">
    <h2 class="text-base font-semibold text-gray-900">Senarai Produk</h2>
    <p class="text-sm text-gray-600 mt-1">Urus produk yang dijual dalam katalog</p>
  </div>

  <div class="p-5">
    <div class="flex justify-between items-center mb-4">
      <div class="text-sm text-gray-700">
        Jumlah produk: <span class="font-semibold"><?= count($products ?? []); ?></span>
      </div>
    ...
    <?php if (empty($products)): ?>
      <div class="text-center py-8">
        ...
        <h3 class="text-lg font-medium text-gray-900 mb-2">Tiada produk dijumpai</h3>
        <p class="text-gray-600 mb-4">Mula tambah produk pertama anda</p>
        <a href="<?= site_url('admin/product_management/create'); ?>" class="inline-flex items-center rounded-md bg-sky-600 text-white px-4 py-2 text-sm font-semibold hover:bg-sky-700">
        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Susunan</th>
...
function confirmDelete(productId, productName) {
  if (confirm('Adakah anda pasti mahu memadam produk "' + productName + '"? Tindakan ini tidak boleh dibuat asal.')) {
